...
//        }
    ...
    private static void showBigPictureNotify(Context ctx, int noticeId, String title, String summaryText, PendingIntent intent) {
        NotificationCompat.Builder mBuilder = new NotificationCompat.Builder(ctx, null);
        mBuilder.setSmallIcon(R.mipmap.ic_launcher);
        mBuilder.setLargeIcon(BitmapFactory.decodeResource(ctx.getResources(), R.mipmap.ic_launcher));
        mBuilder.setContentIntent(intent);
        mBuilder.setAutoCancel(true);
        mBuilder.setTicker(title);
        mBuilder.setPriority(NotificationManagerCompat.IMPORTANCE_HIGH);
        ...
        bigTextStyle.setBigContentTitle(title)
                .setSummaryText(summaryText)
                .bigLargeIcon(BitmapFactory.decodeResource(ctx.getResources(), R.mipmap.ic_launcher))
                .bigPicture(BitmapFactory.decodeResource(ctx.getResources(), R.mipmap.notification_big_picture));
        mBuilder.setStyle(bigTextStyle);
