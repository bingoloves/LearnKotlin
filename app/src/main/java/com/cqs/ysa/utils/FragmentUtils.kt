...
object FragmentUtils{
     ...
     */
    fun showHide(showIndex: Int, fragments:Array<Fragment>) {
        showHide(fragments[showIndex], fragments)
    }
//    fun showHide(showIndex: Int, fragments: Array<Fragment?>) {
//        showHide(fragments[showIndex], *fragments)
//    }
     ...
     * @param hide The fragment will be hide.
     */
    fun showHide(show: Fragment, hide: Array<Fragment>) {
        for (fragment in hide) {
            putArgs(fragment, fragment !== show)
        }
    ...
    private class Args internal constructor(internal val id: Int, internal val tag: String?,
                                            internal val isHide: Boolean, internal val isAddStack: Boolean) {

        internal constructor(id: Int, isHide: Boolean, isAddStack: Boolean) : this(id, null, isHide, isAddStack) {}
    }
