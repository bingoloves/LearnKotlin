...
/**
 * 有了StandardGSYVideoPlayer，还新建MyStandardGSYVideoPlayer，是因为在StandardGSYVideoPlayer因依赖的的第三方的类，在此类中不能做任何修改，
 * 只能新建MyStandardGSYVideoPlayer完全复制StandardGSYVideoPlayer，以便做修改
 */

public class XGSYVideoPlayer extends GSYVideoPlayer {
     ...
     */
    public XGSYVideoPlayer(Context context, Boolean fullFlag) {
        super(context, fullFlag);
    }

    public XGSYVideoPlayer(Context context) {
        super(context);
    }

    public XGSYVideoPlayer(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public void startPlayLogic() {
        if (mVideoAllCallBack != null) {
            ...
            mVideoAllCallBack.onClickStartThumb(mOriginUrl, mTitle, XGSYVideoPlayer.this);
        }
        prepareVideo();
    ...
    protected void cloneParams(GSYBaseVideoPlayer from, GSYBaseVideoPlayer to) {
        ...
        XGSYVideoPlayer sf = (XGSYVideoPlayer) from;
        XGSYVideoPlayer st = (XGSYVideoPlayer) to;
    ...
    public GSYBaseVideoPlayer startWindowFullscreen(Context context, boolean actionBar, boolean statusBar) {
        ...
        if (gsyBaseVideoPlayer != null) {
            XGSYVideoPlayer gsyVideoPlayer = (XGSYVideoPlayer) gsyBaseVideoPlayer;
...
//        setViewShowState(mStartButton, VISIBLE);
        setViewShowState(mStartButton, INVISIBLE);//隐藏播放按钮
...
//        setViewShowState(mStartButton, VISIBLE);
     ...
     * 全屏的UI逻辑
     */
    private void initFullUI(XGSYVideoPlayer standardGSYVideoPlayer) {
